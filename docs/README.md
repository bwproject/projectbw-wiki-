...
features:
  ...
  - title: 🔧 Бот для Поддержки пользователей сервера 🔧
    details: Бот в Телеграмм [Support bot](t.me/ProjectBW_Support_bot) В Чате с Ботом можно получить ответ на FAQ  В Чате с Ботом можно задать свой вопро - На вопрос Вам ответит Администрация сервера
